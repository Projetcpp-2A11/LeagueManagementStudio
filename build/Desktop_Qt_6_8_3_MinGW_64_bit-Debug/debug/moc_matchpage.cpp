...
namespace {
struct qt_meta_tag_ZN9MatchPageE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN9MatchPageE = QtMocHelpers::stringData(
    "MatchPage",
...
Q_CONSTINIT static const uint qt_meta_data_ZN9MatchPageE[] = {
...
Q_CONSTINIT const QMetaObject MatchPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9MatchPageE.offsetsAndSizes,
    qt_meta_data_ZN9MatchPageE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9MatchPageE_t,
        // Q_OBJECT / Q_GADGET
...
void *MatchPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9MatchPageE.stringdata0))
