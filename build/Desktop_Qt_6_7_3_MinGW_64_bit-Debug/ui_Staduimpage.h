...
""));
        ...
        searchStaduimInput->setGeometry(QRect(120, 70, 181, 31));
        QFont font1;
...
""));
        ...
        Name->setGeometry(QRect(80, 122, 301, 31));
        Name->setFont(font1);
...
""));
        ...
        AddStadium->setGeometry(QRect(350, 490, 241, 61));
...
"}"));
        ...
        capacity->setGeometry(QRect(80, 240, 301, 31));
...
""));
        ...
        status->setGeometry(QRect(80, 300, 301, 31));
...
"}"));
    ...
    void retranslateUi(QWidget *Staduimpage)
    {
        ...
        ___qtablewidgetitem2->setText(QCoreApplication::translate("Staduimpage", "ID", nullptr));
