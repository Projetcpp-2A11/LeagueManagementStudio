...
""));
        ...
        save_exit->setGeometry(QRect(140, 390, 192, 51));
...
""));
        ...
        cancel->setGeometry(QRect(340, 390, 211, 51));
...
"}\n"
""));
        playerNumLabel = new QLineEdit(area);
        playerNumLabel->setObjectName("playerNumLabel");
        playerNumLabel->setGeometry(QRect(50, 290, 151, 31));
        playerNumLabel->setStyleSheet(QString::fromUtf8("QLineEdit {\n"
"    background-color: white;\n"
"    padding: 5px;\n"
"    color: black;\n"
"    font-size: 16px;\n"
...
""));
    ...
    void retranslateUi(QWidget *playerupdateform)
    {
        ...
        playerNumLabel->setPlaceholderText(QCoreApplication::translate("playerupdateform", "Player Number", nullptr));
    } // retranslateUi
