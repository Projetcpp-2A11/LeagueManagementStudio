...
""));
        ...
        applyFilterButton->setGeometry(QRect(150, 420, 192, 51));
...
""));
        ...
        cancel->setGeometry(QRect(350, 420, 192, 51));
...
""));
        ...
        filtre = new QComboBox(area1);
        filtre->addItem(QString());
        filtre->addItem(QString());
        filtre->setObjectName("filtre");
        filtre->setGeometry(QRect(330, 120, 201, 31));
    ...
    void retranslateUi(QDialog *Dialog)
    {
        ...
        filtre->setItemText(0, QCoreApplication::translate("Dialog", "Trier par date (Croissante)", nullptr));
        filtre->setItemText(1, QCoreApplication::translate("Dialog", "Trier par date (D\303\251croissante)", nullptr));
