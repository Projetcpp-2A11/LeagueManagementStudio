...
""));
        ...
        tabWidgetTeams->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
...
""));
        ...
        searchTeamsInput->setGeometry(QRect(120, 70, 191, 51));
        QFont font1;
...
""));
        ...
        searchButton->setGeometry(QRect(320, 70, 66, 51));
...
""));
        ...
        exportListButton->setGeometry(QRect(90, 560, 192, 51));
        QFont font2;
...
""));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8("textures/exportIcon.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        nextPageTable->setGeometry(QRect(740, 570, 66, 41));
...
""));
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/textures/textures/prevIcon.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        nextPageTable->setIcon(icon2);
        prevPageTable = new QPushButton(tab);
        prevPageTable->setObjectName("prevPageTable");
        prevPageTable->setGeometry(QRect(820, 570, 66, 41));
...
""));
        ...
        refreshButton->setGeometry(QRect(830, 80, 66, 51));
...
""));
        ...
        teamsNationality->setFont(font3);
...
""));
        ...
        addLogoButton->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
...
""));
        ...
        addKitButton->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
