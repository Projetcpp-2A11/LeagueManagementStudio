...
constexpr auto qt_meta_stringdata_CLASSplayerPageENDCLASS = QtMocHelpers::stringData(
    ...
    "on_player_performance_clicked",
    "on_sortButton_clicked",
    "refresh",
    "on_searchLineEdit_cursorPositionChanged",
    "arg2",
...
Q_CONSTINIT const QMetaObject playerPage::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSplayerPageENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<int, std::false_type>,
        // method 'on_player_performance_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<int, std::false_type>,
        ...
        // method 'refresh'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_searchLineEdit_cursorPositionChanged'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<int, std::false_type>,
...
void playerPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->on_addPlayerButton_clicked(); break;
        case 4: _t->setupPlayerTable(); break;
        case 5: _t->on_refreshButton_clicked(); break;
        case 6: _t->on_delete_player_clicked((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 7: _t->on_update_player_clicked((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 8: _t->on_player_performance_clicked((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
