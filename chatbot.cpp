...
Chatbot::Chatbot(connection* conn) : dbConnection(conn) {  // Use dbConnection instead of connection
...
Chatbot::~Chatbot() {
    // If your 'connection' class has a closeConnection method, call it here
